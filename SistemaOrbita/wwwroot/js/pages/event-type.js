...
function loadDataTable() {
    ...
    dataTable = $("#dataTable").DataTable({
        "ajax": {
            "url": "/BusinessManagement/EventType/GetAll",
        },
        "columns": [
            { "data": "name", "width": "20%" },
            { "data": "description", "width": "25%" },
            {
                ...
                "render": function (data) {
                    if (data == 0) {
                        return '<button type="button" class="btn btn-sm btn-outline-success" style="cursor:auto" title="Bonus"><i class="bi bi-currency-dollar" ></i></button>';
                    }
                    else {
                        return '<button type="button" class="btn btn-sm  btn-outline-danger" title="Discount"><i class="bi bi-currency-dollar"></i></button>'
                ...
                "render": function (data) {
                    return `
                        <div class="text-center">
                            <a href="/BusinessManagement/EventType/Upsert/${data}" class="btn btn-sm btn-info text-white" style="cursor:pointer" title="Update event"> 
                                <i class="bi bi-pencil-square" style="font-size:0.8rem;"></i>
                            </a>
                            <a onclick=Delete("/BusinessManagement/EventType/Delete/${data}") class="btn btn-sm btn-danger text-white" style="cursor:pointer" title="Delete event"> 
